...
def move_robot_go(dataSrv):
    ...
    while (math.sqrt(math.pow(robotPose.position.x,2)+math.pow(robotPose.position.y,2))-math.sqrt(math.pow(init_pose.position.x,2)+math.pow(init_pose.position.y,2))<=1.0):
